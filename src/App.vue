...
export default {
    ...
    methods: {
        ...
        setupClientBindings() {
            ...
            window.ue.interface.onNodePositionUpdate =
                this.onNodePositionUpdate;
            window.ue.interface.ZFonNodePositionUpdate =
                this.ZFonNodePositionUpdate;
            window.ue.interface.ZDonNodePositionUpdate =
                this.ZDonNodePositionUpdate;
            window.ue.interface.SSonNodePositionUpdate =
                this.SSonNodePositionUpdate;
