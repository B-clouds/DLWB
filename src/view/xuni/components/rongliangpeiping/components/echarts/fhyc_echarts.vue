<template>
  <div id="fhyc_echarts" style="width: 100%; height: 100%"></div>
</template>
...
export default {
  ...
  data() {
    return {
      pieData: [],
      xData: ["2023", "2024", "2025", "2026", "2027"],
      yData: [60, 65, 30, 40, 50],
    };
  },
  mounted() {
    this.myecharts();
  ...
  methods: {
    ...
    myecharts() {
      let myChart = this.$echarts.init(document.getElementById("fhyc_echarts"));
      myChart.clear();
      // 渲染
      var option = {
        tooltip: {
