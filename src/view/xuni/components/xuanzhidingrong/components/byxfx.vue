...
export default {
  ...
  methods: {
    ...
    async NecessityAnalysisFn() {
      this.$axios
        .get(
          window.wgApiUrl + "/siteSelection/siteSelectionNecessityAnalysis",
          {
            params: {
              areaId: "10000",
            },
...
.j_t > .blocks > .lefts > .img3 {
  width: 30px;
  height: 30px;
  position: absolute;
  left: 16px;
  top: 2px;
  background: url("img/by1.png") no-repeat !important;
  background-size: 100% 100% !important;
}
.j_t > .blocks > .lefts > .img4 {
  width: 30px;
  height: 30px;
  position: absolute;
  left: 16px;
  top: 2px;
  background: url("img/by2.png") no-repeat !important;
  background-size: 100% 100% !important;
}
.j_t > .blocks > .lefts > .img5 {
  width: 30px;
  height: 30px;
  position: absolute;
  left: 16px;
  top: 2px;
  background: url("img/by3.png") no-repeat !important;
  background-size: 100% 100% !important;
}
.j_t > .blocks > .lefts > .img6 {
  width: 30px;
  height: 30px;
  position: absolute;
  left: 16px;
  top: 2px;
  background: url("img/by4.png") no-repeat !important;
  background-size: 100% 100% !important;
}
.j_t > .blocks > .rights {
  width: 78px;
