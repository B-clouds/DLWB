...
export default {
  ...
  methods: {
    ...
    //电网分析-多元负荷v1-设施现状-基本情况
    async BasicFacilitiesInfoFn() {
      this.$axios
        .get(
          window.wgApiUrl + "/multipleLoad/siteSelectionBasicFacilitiesInfo",
          {
            params: {
              areaId: "10000",
            },
    ...
    //电网分析-多元负荷v1-设施现状-负载情况
    async LoadInfoFn() {
      this.$axios
        .get(window.wgApiUrl + "/multipleLoad/siteSelectionLoadInfo", {
          params: {
            areaId: "10000",
          },
        })
