...
export default {
  ...
  data() {
    return {
      ...
      cftuiy: "", //存放退运日期
      dataList3: [
        { a1: "xxxx", a2: "xxxx", a3: "xxxx", a4: "xxxx", a5: "xxxx" },
        { a1: "xxxx", a2: "xxxx", a3: "xxxx", a4: "xxxx", a5: "xxxx" },
        { a1: "xxxx", a2: "xxxx", a3: "xxxx", a4: "xxxx", a5: "xxxx" },
        { a1: "xxxx", a2: "xxxx", a3: "xxxx", a4: "xxxx", a5: "xxxx" },
        { a1: "xxxx", a2: "xxxx", a3: "xxxx", a4: "xxxx", a5: "xxxx" },
      ...
      tableColumnList: [
        { propName: "电缆ID", prop: "a1" },
        { propName: "电缆名称", prop: "a2" },
        { propName: "电压等级", prop: "a3" },
        { propName: "电缆线径", prop: "a4" },
        { propName: "所属线路", prop: "a5" },
      ],
      featureInfoList: [],
      tk_title: "", //新增编辑表头
      showAdTk: "", //是否显示新增弹框
  ...
  mounted() {
    ...
    that.cfty = window.xzjgwhData.tyrq;
    that.cftuiy = window.xzjgwhData.tuiyrq;

    setTimeout(() => {
      // 获取表头
      let v = {
        URL: "data/tableColumnInfo/" + 112 + "/" + 0 + "/" + 112 + "/" + 1,
        StructName: "获取站房选址间隔维护表头",
        verbType: "GET",
      };
      let data2 = {
        functionName: "WebServerMsg",
        backFunctionName: "getxlThXZWH",
        functionParameters: [
          {
            key: "WebServerMsg",
      ...
      window.ue.interface.getxlThXZWH = that.getxlThXZWH;
    }, 50);
  ...
  methods: {
    ...
    getDataList() {
      ...
      let v = {
        URL: "/xa/customQuery",
        StructName: "获取间隔维护左侧信息",
        verbType: "POST",
        value: {
          name: "Data_HSIntervalInfo",
          pageNo: 1,
          pageSize: 100,
          tbName: "HSIntervalInfo",
          data: [
            {
              key: "ssdz",
              value: this.cfOid,
    ...
    selectData(e) {
      ...
      let data2 = data.data.HSIntervalInfo;
    ...
    updClick() {
      if (this.currentIndex != 1) {
        ...
        if (this.selectList1001.oid != undefined || null || "") {
          ...
          this.isAdd_Update = 1;
          this.tk_title = "编辑弹框";
          this.jgdymc = this.selectList1001.jgdymc;
          this.jgdylx = this.selectList1001.jgdylx;
    ...
    addUpdataClick() {
      if (this.isAdd_Update == 0) {
        ...
        let newDatas = {};
        newDatas["oid"] = this.getSjc;
        newDatas["jgdymc"] = this.jgdymc;
        newDatas["bdgx"] = 0;
        newDatas["dydj"] = this.dydj_value;
        newDatas["ssdz"] = window.xzjgwhData.oid;
        newDatas["ssdt"] = window.xzjgwhData.ssdt;
        newDatas["fbzt"] = window.xzjgwhData.fbzt;
        newDatas["zdycj"] = window.xzjgwhData.zdycj;
        newDatas["tyrq"] = window.xzjgwhData.tyrq;
        newDatas["tuiyrq"] = window.xzjgwhData.tuiyrq;
        newDatas["Str_VallD"] = window.xzjgwhData.Str_VallD;
        newDatas["sfxzdw"] = window.xzjgwhData.sfxzdw;
        let v = {
          TwinType: "HSInterval",
          ModifyType: "New",
          Data: newDatas,
        ...
        let data = {
          functionName: "CustomGeneration",
          backFunctionName: "HSIntervalAdd",
          functionParameters: [
            {
              key: "CustomGeneration",
              value: JSON.stringify(v),
        ...
        ue.interface.broadcast("PSAPI", JSON.stringify(data));
        window.ue.interface.HSIntervalAdd = this.HSIntervalAdd;
      } else {
        // 编辑数据
        let newData = this.selectList1001;
        newData.jgdymc = this.jgdymc;
        newData.jgdylx = this.jgdylx;
        ...
        let data = {
          functionName: "CustomGeneration",
          backFunctionName: "hsUpdateSucess",
          functionParameters: [
            {
              key: "CustomGeneration",
              value: JSON.stringify(v),
        ...
        ue.interface.broadcast("PSAPI", JSON.stringify(data));
        window.ue.interface.hsUpdateSucess = this.hsUpdateSucess;
      }
    },
    // 编辑回调
    hsUpdateSucess() {
    ...
    gClick3(row) {
      ...
      if (this.selectList1001 != row) {
        ...
        window.XZJGBDGX = this.selectList1001;
...
.j_t > .blocks > .lefts > .img1 {
  ...
  left: 20px;
  top: 6px;
  background: url("img/lj4.png") no-repeat !important;
  background-size: 100% 100% !important;
}
.j_t > .blocks > .lefts > .img2 {
  ...
  left: 22px;
  top: 6px;
  background: url("img/lj3.png") no-repeat !important;
  background-size: 100% 100% !important;
}
.j_t > .blocks > .rights {
  width: 88px;
