<template>
    <div class="buidan">
      ...
      >
        ...
        <transition name="transitionLeft">
            <div
                v-show="show && showItem && showkaiguan && !showNeiJing"
        ...
        <!-- 站房选址-自定义建站内景页面左侧 -->
        <transition name="transitionLeft">
            <wuli2 v-show="show && showItem && showXX3 && showNeiJing"></wuli2>
        </transition>
        <!-- 站房选址-自定义建站内景页面右侧 -->
        <transition name="transitionRight">
            <kongjian2
                v-show="show && showItem && showXX3 && showNeiJing"
            ></kongjian2>
        </transition>
    </div>
</template>
...
import wuli2 from "./components/wuli2.vue";
...
export default {
    ...
    methods: {
        ...
        fhMrClick() {
            ...
            let v2 = { ChooseType: "FocusModel", value: "false" };
            let data2 = {
                functionName: "Sundry",
                functionParameters: [
                    {
