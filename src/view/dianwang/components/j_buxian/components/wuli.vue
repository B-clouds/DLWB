    ...
    <div class="jcxx">
      ...
      <div class="b_b_b">
        ...
        <div class="jbBlock">
          ...
          <div class="jbRight2">
            <div class="inputs">
              ...
              <img v-show="!dxlx_show" src="./img/xia.png" />
              <img v-show="dxlx_show" src="./img/shang.png" />
            </div>
          </div>
        </div>
        <div class="jbBlock">
        ...
        <div class="jbBlock">
          ...
          <div class="jbRight2">
            <input v-model="dxcd" placeholder="最大输入不超过10个字" />
          </div>
        </div>
      </div>
      <div class="jbBlock">
...
export default {
  ...
  mounted() {
    ...
    that.$bus.$on("swqds", (e) => {
      that.qsgtmc = e.sbmc;
      that.Str_qsgtLoc = e.x + "," + e.y;
    });
    that.$bus.$on("swzds", (e) => {
      that.zzgtmc = e.sbmc;
      that.Str_zzgtLoc = e.x + "," + e.y;
    });
    that.$bus.$on("setQsgt", (e) => {
      that.qsgt = e.oid;
    });
    that.$bus.$on("setZzgt", (e) => {
      that.zzgt = e.oid;
    });
    that.$bus.$on("goUpdate", (e) => {
      that.updateClick();
    });
    that.$bus.$on("hangObj3", (e) => {
      that.getSjc = e.oid;
      that.sbmc = e.sbmc;
      that.dxlx_value = e.dxlx;
      that.ssxl_value = e.ssxl;
      that.dy_value = e.dydj;
      that.zzgt = e.zzgt;
      that.qsgt = e.qsgt;
      that.qsgtlx = e.qsgtlx;
      that.qsgtmc = e.qsgtmc;
      that.Str_qsgtLoc = e.Str_qsgtLoc;
      that.zzgtlx = e.zzgtlx;
      that.zzgtmc = e.zzgtmc;
      that.Str_zzgtLoc = e.Str_zzgtLoc;
      that.value1 = e.tyrq;
      that.value2 = e.tuiyrq;
      that.ywdw = e.ywdw;
      that.zdycj = e.zdycj;
      that.dxcd = e.dxcd;
    });
    ...
    updateClick() {
      ...
      let v = {
        ...
        Data: {
          ...
          qsgtlx: this.qsgtlx,
          qsgtmc: this.qsgtmc,
          Str_qsgtLoc: this.Str_qsgtLoc,
          zzgtlx: this.zzgtlx,
          zzgtmc: this.zzgtmc,
          Str_zzgtLoc: this.Str_zzgtLoc,
          tyrq: this.value1,
          tuiyrq: this.value2,
          ywdw: this.ywdw,
          zdycj: 1,
