    ...
    methods: {
        ...
        getDatas(e) {
            ...
            this.$nextTick(function () {
                this.$refs.qdlbTable.toggleRowSelection(row);
                // 存放默认选中的起点oid
        ...
        getDatas2(e) {
            ...
            this.$nextTick(function () {
                this.$refs.zdlbTable.toggleRowSelection(row);
                // 存放默认选中的终点oid
        ...
        s_Click3(selection, row) {
            this.$refs.qdlbTable.clearSelection();
        ...
        handleSelectionChange(val) {
            if (val.length > 1) {
                this.$refs.qdlbTable.clearSelection();
                this.$refs.qdlbTable.toggleRowSelection(val.pop());
            }
        },

        s_Click4(selection, row) {
            this.$refs.zdlbTable.clearSelection();
            if (selection.length === 0) {
                return;
            }
            if (row) {
        ...
        handleSelectionChange2(val) {
            if (val.length > 1) {
                this.$refs.zdlbTable.clearSelection();
                this.$refs.zdlbTable.toggleRowSelection(val.pop());
            }
        },
