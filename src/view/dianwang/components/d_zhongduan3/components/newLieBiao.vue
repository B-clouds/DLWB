        ...
        <transition name="transitionLeft">
            <div class="tiaoJian" v-show="showTJ && showXX">
                ...
                <div class="new_block">
                    <!-- 终端名称 -->
                    <div class="tjBlock">
                        <div class="tops">电缆名称</div>
                        <div class="bottoms">
                            <div class="inputs">
                                <div class="inputs">
                                    <input placeholder="" v-model="dlmc" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tjBlock">
                        ...
                        <div class="bottoms">
                            <div class="inputs">
                                <div class="inputs">
                                    <input placeholder="" v-model="qdmc" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tjBlock">
                        ...
                        <div class="bottoms">
                            <div class="inputs">
                                <div class="inputs">
                                    <input placeholder="" v-model="zdmc" />
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    mounted() {
        ...
        // 获取表头
        let v = {
            URL: "data/tableColumnInfo/" + 108 + "/" + 0 + "/" + 108 + "/" + 1,
            StructName: "获取电缆管理表头",
            verbType: "GET",
        };
        let data2 = {
            functionName: "WebServerMsg",
            backFunctionName: "getDLGLTh",
            functionParameters: [
                {
                    key: "WebServerMsg",
        ...
        window.ue.interface.getDLGLTh = this.getDLGLTh;
    },
    methods: {
        getDLGLTh() {},
        // 返回默认页面
        ...
        hang2(row, column, event) {
            if (this.showSelect) {
                this.$refs.mug9.toggleRowSelection(row);
                let arr = [];
                arr.push(row);
                let data = arr;
                let id = arr[0].oid;
        ...
        // 右键清除选中
        unHangClick() {
            this.$refs.mug9.setCurrentRow();
        },
        hang2s(row, column, event) {
            if (this.showSelect) {
                this.$refs.mug10.toggleRowSelection(row);
                let arr = [];
                arr.push(row);
                let data = arr;
                let id = arr[0].oid;
