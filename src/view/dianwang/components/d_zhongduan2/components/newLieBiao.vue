        ...
        <div class="zhezhao" v-show="showTSTK1">
            <div class="z_delete">
                <div class="z_d_block">
                    ...
                    <span
                        >所选数据已为主管廊，无需设置，请核实后再进行该操作</span
                    >
                </div>
                <div class="z_btn2">
        ...
        <div class="zhezhao" v-show="showTSTK7">
            <div class="z_delete">
                <div class="z_d_block">
                    <img class="imgs" src="./img/jj2.png" />
                    <span
                        >单条数据无法进行合并，请选择两条及以上数据，再进行该操作</span
                    >
                </div>
                <div class="z_btn2">
        ...
        <div class="zhezhao" v-show="showTSTK11">
            <div class="z_delete">
                <div class="z_d_block">
                    <img class="imgs" src="./img/jj1.png" />
                    <span
                        >该操作将把所选中的模型合并到主管廊中，是否继续该操作？</span
                    >
                </div>
                <div class="z_btn2">
            ...
            if (this.btnIndex == 1) {
                ...
                if (this.selectList.length > 0) {
                    ...
                    if (this.selectList.length == 1) {
                        console.log(this.selectList, "第一个判断");
                        ...
                        for (let i = 0; i < this.selectList.length; i++) {
                            if (this.selectList[i].sfzgl == "1") {
                                ...
                                console.log(
                                    "01,---------------------------------",
                                    this.selectList[i].sfzgl
                                );
                            } else if (this.selectList[i].hbzt == "1") {
                                num2++;
                                console.log(
                                    "02,---------------------------------",
                                    this.selectList[i].hbzt
                                );
                            }
                        }
                        // 3合并管廊，进行判断
                ...
                // 2分离管廊，进行判断
                for (let i = 0; i < this.selectList.length; i++) {
                    console.log("sfzgl等于1的长度：", num);
                    console.log("hbzt等于0的长度：", num2);
                    if (num > 0) {
