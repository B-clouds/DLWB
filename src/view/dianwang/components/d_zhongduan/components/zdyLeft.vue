  ...
  <div class="zdyLeft">
    <div class="jcxx">
      ...
      <div class="jbBlock">
        ...
        <div class="jbRight2">
          <div class="inputs">
            <el-select v-model="ssxl" @visible-change="xlClick" placeholder="">
              <el-option
                v-for="item in xl"
                :key="item.value"
                :label="item.label"
      ...
      <div class="jbBlock">
        ...
        <div class="jbRight2">
          <div class="inputs">
            <el-select v-model="jmlx" @visible-change="jmClick" placeholder="">
              <el-option
                v-for="item in jm"
                :key="item.value"
                :label="item.label"
      ...
      <div class="jbBlock">
        <div class="jbBtn jbBtn2" v-show="showUpdate" @click="goNeiJing">
          <span>内景视角</span>
        </div>
        <div class="jbBlock">
