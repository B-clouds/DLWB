<template>
    <div class="zdy">
        ...
        <transition name="transitionLeft">
            <zdyLeft
                @goNeiJing="goNeiJing"
                v-show="show && showXX2 && !showNeiJing"
                @showKJ="showKJ"
            ></zdyLeft>
        </transition>
        <!-- 站房选址-自定义建站外景页面右侧 -->
        <transition name="transitionRight">
            <zdyRight
                v-show="show && showXX2 && !showNeiJing && showKongJian"
            ></zdyRight>
        </transition>
        ...
        <transition name="transitionLeft">
            <zdyLeft2
                v-show="show && showXX3 && showNeiJing && showLefts"
            ></zdyLeft2>
        </transition>
        <!-- 站房选址-自定义建站内景页面右侧 -->
        <transition name="transitionRight">
            <zdyRight2
                @showLeft="showLeft"
                v-show="show && showXX3 && showNeiJing"
            ></zdyRight2>
        </transition>
    </div>
</template>
