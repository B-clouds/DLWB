<template>
  <div class="zdy">
    ...
    <transition name="transitionLeft">
      <div
        v-show="show && showKongJian && showkaiguan"
    ...
    <!-- 站房选址-自定义建站页面左侧 -->
    <transition name="transitionLeft">
      <zdyLeft @showKJ="showKJ" v-show="show && showXX2"></zdyLeft>
    </transition>
    <!-- 站房选址-自定义建站页面右侧 -->
    <transition name="transitionRight">
      <zdyRight v-show="show && showXX2 && showKongJian"></zdyRight>
    </transition>
    <!-- 层级选择功能 -->
    <transition name="transitionRight">
      <div class="ceng" v-if="show && showKongJian">
        <div
          class="cengItem"
          @click="cengClick(0)"
