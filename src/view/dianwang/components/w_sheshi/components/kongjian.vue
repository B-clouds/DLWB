...
.e_tabless > .el-table__header tr,
.e_tabless > .el-table__header th {
...
.e_tabless > .el-table__body tr,
.e_tabless > .el-table__body td {
    height: 30px;
    font-family: SourceHanSansSC-Regular;
    font-size: 16px;
    font-weight: normal;
