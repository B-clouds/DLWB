...
export default {
  ...
  data() {
    return {
      ...
      dataList: [],
      tableColumnList: [
        { prop: "td1", propName: "运行杆档案ID" },
        { prop: "td2", propName: "运行杆图形ID" },
        { prop: "td3", propName: "设备编码" },
        { prop: "td4", propName: "所属线路档案名称" },
        { prop: "td5", propName: "杆塔档案名称" },
        { prop: "td6", propName: "电压等级" },
      ],
      //  ----站房类型-----
      wangluo: [
        {
