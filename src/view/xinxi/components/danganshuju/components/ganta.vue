...
export default {
  ...
  data() {
    return {
      ...
      dataList: [],
      tableColumnList: [
        { prop: "td1", propName: "物理杆ID" },
        { prop: "td2", propName: "图形ID" },
        { prop: "td3", propName: "设备编码" },
        { prop: "td4", propName: "设备名称" },
        { prop: "td5", propName: "型号" },
        { prop: "td6", propName: "投运日期" },
        { prop: "td7", propName: "单/双/三杆" },
        { prop: "td8", propName: "主杆埋深" },
        { prop: "td9", propName: "杆塔材质" },
        { prop: "td10", propName: "杆高" },
        { prop: "td11", propName: "同杆架设回路数" },
