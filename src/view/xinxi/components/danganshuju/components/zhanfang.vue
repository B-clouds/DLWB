            ...
            <div class="c_items">
                <div class="c_block">
                    ...
                    <div class="names">
                        ...
                        <div class="inputs">
                            <el-select
                                v-model="wangluo_value"
                                @visible-change="wangluoClick"
                                placeholder=""
                            >
                                <el-option
                                    v-for="item in wangluo"
                                    :key="item.value"
                                    :label="item.label"
                                    :value="item.value"
                                >
                            ...
                            <img v-show="!wangluo_show" src="./img/xia.png" />
                            <img v-show="wangluo_show" src="./img/shang.png" />
                        </div>
                    </div>
                    <div class="names">
                        <span>站房名称</span>
    ...
    data() {
        return {
            ...
            tableColumnList: [
                ...
                { prop: "td2", propName: "站房类型" },
                { prop: "td3", propName: "站房名称" },
                { prop: "td4", propName: "运维单位" },
                { prop: "td5", propName: "电压等级" },
                { prop: "td6", propName: "投运日期" },
                { prop: "td7", propName: "退运日期" },
                { prop: "td8", propName: "设备经纬度" },
                { prop: "td9", propName: "设备高度" },
                { prop: "td10", propName: "设备角度" },
                { prop: "td11", propName: "模型状态" },
            ],
            //  ----站房类型-----
            wangluo: [
                {
