      ...
      <div class="c_items">
        <div class="c_block">
          ...
          <div class="names">
            <span>终点名称</span>
            <div class="inputs">
              <input placeholder="" v-model="search4" />
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      dataList: [],
      tableColumnList: [
        { prop: "td1", propName: "线路档案ID" },
        { prop: "td2", propName: "线路图形ID" },
        { prop: "td3", propName: "设备编码" },
        { prop: "td4", propName: "铭牌运行库ID" },
        { prop: "td5", propName: "线路名称" },
        { prop: "td6", propName: "所属地市" },
        { prop: "td7", propName: "电压等级" },
        { prop: "td8", propName: "调度单位" },
        { prop: "td9", propName: "运行状态" },
        { prop: "td10", propName: "起点名称" },
        { prop: "td11", propName: "终点名称" },
        { prop: "td12", propName: "起点位置" },
        { prop: "td13", propName: "终点位置" },
        { prop: "td14", propName: "投运日期" },
        { prop: "td15", propName: "架设方式" },
        { prop: "td16", propName: "线路总长度" },
        { prop: "td17", propName: "架空线路长度" },
        { prop: "td18", propName: "电缆线路长度" },
        { prop: "td19", propName: "起点开关编号" },
        { prop: "td20", propName: "终点开关编号" },
        { prop: "td21", propName: "模型状态" },
        { prop: "td22", propName: "专业分类名称" },
      ],
      //  ----站房类型-----
      wangluo: [
        {
