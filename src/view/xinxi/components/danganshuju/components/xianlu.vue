    ...
    data() {
        return {
            ...
            tableColumnList: [
                ...
                { prop: "td4", propName: "导线名称" },
                { prop: "td5", propName: "导线类型" },
                { prop: "td6", propName: "导线长度" },
                { prop: "td7", propName: "起点类型" },
                { prop: "td8", propName: "起点ID" },
                { prop: "td9", propName: "起点名称" },
                { prop: "td10", propName: "起点位置" },
                { prop: "td11", propName: "终点类型" },
                { prop: "td12", propName: "终点ID" },
                { prop: "td13", propName: "终点名称" },
                { prop: "td14", propName: "终点位置" },
                { prop: "td15", propName: "运维单位" },
                { prop: "td16", propName: "投运日期" },
                { prop: "td17", propName: "退运日期" },
                { prop: "td18", propName: "模型状态" },
            ],
            //  ----站房类型-----
            wangluo: [
                {
