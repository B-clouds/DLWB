  ...
  <div class="wuli">
    <div class="jcxx">
      ...
      <div class="j_item">
        <div class="items">
          <div class="lefts">
            <span>额定输送功率(MVA)：</span>
          </div>
          <div class="rights">
            <span>{{ rightData.rdgl }}</span>
          </div>
        </div>
        <div class="items">
          <div class="lefts">
