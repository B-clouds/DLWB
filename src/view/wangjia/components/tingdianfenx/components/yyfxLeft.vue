<template>
  <div class="zdfxLeft">
    ...
    <div class="jr_block">
      <div class="j_titles">
        <span class="span1">计划停电分析</span>
      </div>
      <yyfxlOne />
    </div>
    <div class="jr_block">
      <div class="j_titles">
        <span class="span1">故障停电分析</span>
      </div>
      <yyfxlTwo />
    </div>
    <div class="jr_block">
      <div class="j_titles">
        <span class="span1">计划停电原因</span>
      </div>
      <yyfxlThree />
    </div>
  </div>
...
<script>
import yyfxlOne from "./echarts/yyfxlOne.vue";
import yyfxlTwo from "./echarts/yyfxlTwo.vue";
import yyfxlThree from "./echarts/yyfxlThree.vue";
export default {
  name: "zdfxLeft",
  components: {
    yyfxlOne,
