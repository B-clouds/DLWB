<template>
  <div id="yyfxlTwo" style="width: 379px; height: 270px"></div>
</template>
...
export default {
  ...
  methods: {
    ...
    myecharts() {
      let myChart = this.$echarts.init(document.getElementById("yyfxlTwo"));
      myChart.clear();
      this.xLists = ["10次以上", "6-10次", "3-5次", "2次以下"];
      this.y1s = [10, 40, 10, 32];
      this.y2s = [12, 21, 25, 30];
      let option = {
