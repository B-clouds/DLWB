<template>
  <div id="yyfxlOne" style="width: 379px; height: 270px"></div>
</template>
...
export default {
  ...
  methods: {
    ...
    myecharts() {
      let myChart = this.$echarts.init(document.getElementById("yyfxlOne"));
      myChart.clear();
      this.xLists = ["10次以上", "6-10次", "3-5次", "2次以下"];
      this.y1s = [30, 40, 50, 32];
      this.y2s = [12, 18, 25, 40];
      let option = {
