<template>
  <div id="xq" style="width: 379px; height: 282px"></div>
</template>
...
export default {
  ...
  methods: {
    ...
    myecharts() {
      let myChart = this.$echarts.init(document.getElementById("xq"));
      myChart.clear();
      let xList = ["2018年", "2019年", "2020年", "2021年", "2022年", "2023年"];
      let y1 = [61, 65, 96, 59, 54, 69];
      let y2 = [21, 45, 36, 19, 44, 59];
      let total1 = 0;
      let total2 = 0;
